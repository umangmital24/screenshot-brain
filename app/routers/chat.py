...
async def chat(req: ChatRequest, user_id: str = Depends(get_current_user_id)):
    """Natural-language screenshot memory retrieval.

    Samhaal is intentionally retrieval-only here: it finds saved memories and their
    original screenshots. It does not recommend, compare, profile, or reason on
    behalf of the user.
    """
